...
let users = [{ email: "s@t.com", password: "123" },{ email: "kiki@s.com", password: "123" }];
app.use(bodyParser.json());

app.get("/", (req, res) => res.send("Hello"));
app.get("/users", (req, res) => res.send(users));
app.post("/create", (req, res) => res.send(users));
...
// // Get all users
// app.get('http://localhost:3002/users', async (req, res) => {
//   try {
